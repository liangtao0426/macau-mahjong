      ...
      <div className="w-full max-w-md bg-[#F8F3EB] flex flex-col min-h-screen relative pb-28 shadow-xl">
        ...
        <main className="flex-1 px-5 space-y-6">
          ...
          <section>
            <div className="flex justify-between items-center mb-3">
              ...
              <button className="text-xs text-[#8C857B] hover:text-[#0E5C4E] font-medium transition-colors">
                查看全部
              </button>
            </div>
        ...
        <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-[#F0EADF] px-6 py-2 flex justify-around items-center z-50 shadow-[0_-2px_10px_rgba(0,0,0,0.03)]">
          ...
          >
            ...
            <span className={`font-medium ${activeTab === 'score' ? 'text-[#0E5C4E]' : 'text-[#8C857B]'}`}>
              记分
            </span>
          </button>
